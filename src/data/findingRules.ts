...
const r = (
  ...
  extras: Omit<FindingRule, "id" | "labelKo" | "category" | "weights"> = {}
): FindingRule => ({
  id,
  labelKo,
  category,
...
const historyRules: FindingRule[] = [
...
const vitalPhysicalRules: FindingRule[] = [
  r(
    "V28",
    "저혈압 또는 쇼크",
    "vital",
...
const cardiacImagingRules: FindingRule[] = [
...
const thoracicImagingRules: FindingRule[] = [
  r(
    "T93",
...
const mskPsychRules: FindingRule[] = [
